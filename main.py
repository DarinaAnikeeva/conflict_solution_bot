...
*Путь к согласию* - это бот-психолог, который бесплатно поддержит вас, даст варианты решения выхода из конфликтных ситуаций.

Вот, что у меня есть:
*Ситуации* - здесь вы получите практику выхода из конфликтных ситуаций

*Советы* - вы сможете узнать некоторую информацию по конфликтам

*Обратная связь* - можете оставить отзыв о боте, предложить улучшения или, если что-то пойдет не так, то опишите проблему
""",
        reply_markup=markup,
